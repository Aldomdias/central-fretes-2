...
function exportarExcel(laudo = {}, externo) {
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(oportunidadesExcel(laudo.listaLaudoSegura(laudo?.ufsCriticas, laudo?.ufsPrioritarias) || laudo.ufsPrioritarias || [])), 'UFs Prioritarias');
  ...
  return (
    <article className="laudo-rodadas-page" ref={laudoRef}>
      ...
      <div className="laudo-rodadas-body">
        ...
        <TabelaSimples titulo="Visão por Estado/UF" linhas={(laudo.listaLaudoSegura(laudo?.ufsCriticas, laudo?.ufsPrioritarias) || laudo.ufsPrioritarias || []).slice(0, 8)} tipo="uf" />
