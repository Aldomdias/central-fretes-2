-- 4.36.2.11 — Cole no SQL Editor do Supabase (correção mapa vazio + Failed to fetch)
-- Arquivo espelho: supabase/migrations/20260609_011_avaliacao_prazos_mapa_ibge_limites.sql
