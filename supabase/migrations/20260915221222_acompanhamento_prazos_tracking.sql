-- Painel operacional de prazos do Tracking, agregado no servidor.
...
create index if not exists idx_tracking_rows_data_transportadora_prazo on public.tracking_rows (data, transportadora) include (previsao_cliente, data_entrega);
