...
create policy cadastros_snapshot_select on public.cadastros_snapshot for select to anon, authenticated using (true);
create policy cadastros_snapshot_insert on public.cadastros_snapshot for insert to anon, authenticated with check (true);
create policy cadastros_snapshot_update on public.cadastros_snapshot for update to anon, authenticated using (true) with check (true);
...
create policy frete_importacoes_select on public.frete_importacoes for select to anon, authenticated using (true);
create policy frete_importacoes_insert on public.frete_importacoes for insert to anon, authenticated with check (true);
