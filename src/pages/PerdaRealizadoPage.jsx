...
export default function PerdaRealizadoPage() {
  ...
  const detalhesVisiveis = useMemo(() => {
    ...
    if (filtroTab.transportadora) { const t = filtroTab.transportadora.toUpperCase(); lista = lista.filter((d) => d.transportadoraRealizada?.toUpperCase().includes(t) || d.transportadoraGanhadora?.toUpperCase().includes(t)); }
