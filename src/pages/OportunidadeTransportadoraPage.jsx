...
function exportarExcel({ resultado, scenarioMode, filtros, dataInicio, dataFim, competencia, canal }) {
  ...
  const dados = linhasTodas.map((l) => {
    ...
    return {
      ...
      'Δ ref→atual (%)': l.freteNfPctRef != null && l.freteNfPctAtual != null && l.freteNfPctRef > 0 ? ((l.freteNfPctAtual - l.freteNfPctRef) / l.freteNfPctRef) : '',
      'Simulado (R$)': l.chainCustoTotal != null ? l.chainCustoTotal : l.melhorTotal,
      'Frete % NF simulado': (() => { const s = l.chainNfPct ?? l.freteNfPctMelhor; return s != null ? s / 100 : ''; })(),
      'Δ ref→simulado (%)': (() => { const s = l.chainNfPct ?? l.freteNfPctMelhor; return l.freteNfPctRef != null && s != null && l.freteNfPctRef > 0 ? (s - l.freteNfPctRef) / l.freteNfPctRef : ''; })(),
