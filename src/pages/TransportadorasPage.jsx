...
function OrigemDetail({ transportadora, origem, onBack, store }) {
  ...
  const taxasColumns = [
    { key: 'ibgeDestino', label: 'IBGE Destino' }, { key: 'tda', label: 'TDA (R$)' }, { key: 'tdr', label: 'TDR (R$)' }, { key: 'trt', label: 'TRT (R$)' }, { key: 'suframa', label: 'SUFRAMA (R$)' }, { key: 'outras', label: 'Outras (R$)' }, { key: 'gris', label: 'GRIS (%)' }, { key: 'grisMinimo', label: 'GRIS Mín.' }, { key: 'adVal', label: 'Ad Val (%)' }, { key: 'adValMinimo', label: 'Ad Val Mín.' }, { key: 'taxaExtraNome', label: 'Coringa' }, { key: 'taxaExtraValor', label: 'Coringa R$' }, { key: 'taxaExtraPct', label: 'Coringa %' }, { key: 'taxaExtraMin', label: 'Coringa Mín.' },
  ];
  const taxasFields = [
    { name: 'ibgeDestino', label: 'IBGE Destino' }, { name: 'tda', label: 'TDA (R$)' }, { name: 'tdr', label: 'TDR (R$)' }, { name: 'trt', label: 'TRT (R$)' }, { name: 'suframa', label: 'SUFRAMA (R$)' }, { name: 'outras', label: 'Outras (R$)' }, { name: 'gris', label: 'GRIS (%)' }, { name: 'grisMinimo', label: 'GRIS Mínimo (R$)' }, { name: 'adVal', label: 'Ad Valorem (%)' }, { name: 'adValMinimo', label: 'Ad Valorem Mínimo (R$)' }, { name: 'taxaExtraNome', label: 'Taxa Coringa (nome)' }, { name: 'taxaExtraValor', label: 'Coringa R$ fixo' }, { name: 'taxaExtraPct', label: 'Coringa % NF' }, { name: 'taxaExtraMin', label: 'Coringa Mínimo (R$)' },
  ];
