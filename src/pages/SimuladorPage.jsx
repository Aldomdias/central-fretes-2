                    ...
                    {ehReajusteResultado && (
                      <>
                        ...
                        <div className="summary-strip" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))' }}>
                          ...
                          <div className="summary-card"><span>Uso correto da tabela atual</span><strong>{formatPercent(aderenciaAtual.aderenciaOperacional || 0)}</strong><small>{Number(aderenciaAtual.ctesAderentes || 0).toLocaleString('pt-BR')} CT-es usados corretamente; {Number(aderenciaAtual.ctesNaoAderentes || 0).toLocaleString('pt-BR')} fora da aderencia</small></div>
