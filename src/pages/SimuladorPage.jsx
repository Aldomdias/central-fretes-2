...
function rotuloTabelaLaudoAjuste(nome = 'Tabela') {
...
function chaveRotaFaixaLaudo(rota = '', faixa = '') {
...
<body>
  ...
  const exportarExcelAjusteRotaFaixaTransportador = ({ incluirSavingGerencial = false } = {}) => {
    ...
    const ctesExcelCompletos = Array.isArray(resultadoRealizado.ctesAjusteRotaExcel) && resultadoRealizado.ctesAjusteRotaExcel.length
      ? resultadoRealizado.ctesAjusteRotaExcel.filter((cte) => chavesRotasAtendidas.has(chaveRotaFaixaLaudo(cte.rota, cte.faixaPeso || cte.faixa || '')))
