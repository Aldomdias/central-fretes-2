...
export function resumoResultadoRealizado(resultado = {}) {
  return {
    ...
    pesoGanhariaSelecionada: toNumber(resultado.pesoGanhariaSelecionada),
    volumesGanhariaSelecionada: toNumber(resultado.volumesGanhariaSelecionada),
    cubagemGanhariaSelecionada: toNumber(resultado.cubagemGanhariaSelecionada),
    ctesRetidosSelecionada: toNumber(resultado.ctesRetidosSelecionada),
    freteRealizadoRetidoSelecionada: toNumber(resultado.freteRealizadoRetidoSelecionada),
    freteSelecionadaRetida: toNumber(resultado.freteSelecionadaRetida),
    valorNFRetidoSelecionada: toNumber(resultado.valorNFRetidoSelecionada),
    pesoRetidoSelecionada: toNumber(resultado.pesoRetidoSelecionada),
    volumesRetidosSelecionada: toNumber(resultado.volumesRetidosSelecionada),
    cubagemRetidaSelecionada: toNumber(resultado.cubagemRetidaSelecionada),
    ctesCapturadosDeOutras: toNumber(resultado.ctesCapturadosDeOutras),
    freteCapturadoRealizado: toNumber(resultado.freteCapturadoRealizado),
    freteCapturadoTabela: toNumber(resultado.freteCapturadoTabela),
    valorNFCapturado: toNumber(resultado.valorNFCapturado),
    pesoCapturado: toNumber(resultado.pesoCapturado),
    volumesCapturados: toNumber(resultado.volumesCapturados),
    cubagemCapturada: toNumber(resultado.cubagemCapturada),
    faturamentoProjetadoNegociacao: toNumber(resultado.faturamentoProjetadoNegociacao),
    faturamentoProjetadoNegociacaoMes: toNumber(resultado.faturamentoProjetadoNegociacaoMes),
    faturamentoProjetadoNegociacaoAno: toNumber(resultado.faturamentoProjetadoNegociacaoAno),
    savingProjetadoNegociacao: toNumber(resultado.savingProjetadoNegociacao),
    savingProjetadoNegociacaoMes: toNumber(resultado.savingProjetadoNegociacaoMes),
    savingProjetadoNegociacaoAno: toNumber(resultado.savingProjetadoNegociacaoAno),
  };
}
