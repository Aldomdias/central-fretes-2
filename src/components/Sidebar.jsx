...
const ICONS = {
  ...
  'oportunidade-origem': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z" />,
...
const menuPrincipal = [
  ...
  { chave: 'auditoria-cte',      label: 'Laboratorio Auditoria CT-e' },
  ...
  { chave: 'faturas',            label: 'Central Auditoria Fretes' },
