  ...
  return {
    ...
    detalhes: {
      frete: {
        ...
        excessoKg: toNumber(calculo.componentesBase?.excessoPorKg ?? cotacao.excesso),
        pesoLimiteExcedente: toNumber(calculo.pesoLimiteExcedente ?? calculo.componentesBase?.pesoLimiteExcedente),
        pesoExcedente: toNumber(calculo.excedenteKg ?? calculo.componentesBase?.excedenteKg),
        valorExcedente: toNumber(calculo.valorExcedente),
        valorExcedenteUnitario: toNumber(calculo.componentesBase?.excessoPorKg),
