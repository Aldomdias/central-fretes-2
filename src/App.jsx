...
import CtesPage from './pages/RealizadoLocalPage';
...
function primeiraPaginaPermitida(usuario) {
  const candidatas = ['dashboard', 'simulador', 'ctes', 'tracking', 'torre-controle', 'reajustes', 'importacao', 'formatacao', 'importar-template', 'lotacao', 'lotacao-operacao', 'lotacao-auditoria', 'consulta-ibge', 'ferramentas', 'transportadoras', 'usuarios', 'minha-senha'];
...
export default function App() {
  ...
  if (paginaAtual === 'ctes') {
    content = <CtesPage transportadoras={transportadorasMemo} />;
  }
